...
from merge_keepkv import merge_Ke_to_Kc, Repair
...
print("--------before merge--------")
generated_tokens, durations_cached_s = generate_text(30, next_inputs)
...
print("--------after merge--------")
generated_tokens_merged, durations_cached_s_merged = generate_text(30, next_inputs_merged)
