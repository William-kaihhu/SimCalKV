...
print("--------before merge--------")
generated_tokens, durations_cached_s = generate_text(model, tokenizer, 20, next_inputs)
...
past_key_values_merged = Repair(model, past_key_values, attention, hidden_states, 0.15)
...
print("--------after merge--------")
generated_tokens_merged, durations_cached_s_merged = generate_text(model, tokenizer, 20, next_inputs_merged)
generated_tokens_merged = next_token + generated_tokens_merged
