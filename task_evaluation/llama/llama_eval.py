...
def main():
    ...
    parser.add_argument("--split", type=str, default="test[:2]")
    ...
    for dataset in datasets:
        ...
        try:
            ...
            summary_json = f"{args.output_dir}/llama_summary_{dataset_name}_{args.kv_method}_{args.compress_ratio}.json"
            summary = {
                "dataset": dataset,
                "kv_method": args.kv_method,
