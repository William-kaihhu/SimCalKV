...
### Evaluation
We take **LLama3.1-8B** as an example and provide two example commands for running. **Detailed parameter configurations can be found in** `task_evaluation/instructions.md`.
